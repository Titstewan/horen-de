...
\subsubsection{} \N{Le-} bildet Adjektive aus anderen Wörtern, sehr häufig aus Substantiven, wie beispielsweise \N{le\ACC{hrr}ap} \E{gefährlich} aus \N{\ACC{hrr}ap} \E{Gefahr}. Es gibt aber auch Formen, die von Verben abgeleitet sind (\N{le\ACC{ha'}} \E{geeignet, passend} von \N{ha'} \E{passen, geeignet sein}), von einer Partikel (\N{le\ACC{tut}} \E{andauernd, ständig} von \N{tut}, einem Fortsetzungsmarker), von Adverbien (\N{le\ACC{ye'}krr} \E{früh, zeitig} von \N{ye'krr} \E{früh}) sowie aus Zusammensetzungen oder Phrasen (\N{le\ACC{pxìm}rum} \E{gewöhnlich, häufig anzutreffen} von \N{pxìm} \E{oft,} \N{run} \E{finden}).
