...
\section{Zeit}
\noindent Adverbien der Zeit werden nach einem regelmäßigen Muster von Substantiven abgeleitet. Daher können diese Wörter auch substantivisch verwendet werden und Kasusendungen erhalten, \Npawl{\uwave{trramä} ayuvanìri makto Akwey nìyewla ha snaytx} \E{Bei den gestrigen Spielen ist Akwey enttäuschend geritten, also hat er verloren}.

\subsection{Die momentane Zeit} Das Nominalpräfix \N{fì-} (\horenref{morph:prenoun:fi}) bildet ein Adverb für die aktuelle Zeiteinheit, \N{fìtrr} \E{heute} (wörtl. \E{dieser Tag}), \N{fìrewon} \E{heute Morgen}. \index{fiì-@\textbf{fì-}!in Zeitadverbien}
