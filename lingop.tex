...
\begin{interlin}
	...
	\I{dem}-Jäger-\I{dim} \I{neg} können nichts-\I{pat} fangen\INF{\I{subj}} \\
...
\begin{interlin}
	...
	\I{1sg} bekanntlich \I{comp} \I{1sg-dim} sein stark \I{advz}-viel \\
	\trans{Du bist bekanntlich viel stärker als \uwave{meine Wenigkeit}.}
\end{interlin}

Nur über den Kontext kann die die abschätzige von der liebevollen Verwendung des Diminutivs unterschieden werden.
...
\begin{interlin}
	...
	Fluss-Zustand sein Art-und-Weise-\I{q} \I{dem}-Tag \\
