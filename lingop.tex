...
\subsubsection{} \N{Le-} bildet Adjektive aus anderen Wörtern, sehr häufig aus Substantiven, wie beispielsweise \N{le\ACC{hrr}ap} \E{gefährlich} von \N{\ACC{hrr}ap} \E{Gefahr}. Es gibt aber auch Formen, die von Verben abgeleitet sind (\N{le\ACC{ha'}} \E{passend, geeignet} von \N{ha'} \E{passen, geeignet sein}), von einer Partikel (\N{le\ACC{tut}} \E{andauernd, ständig} von \N{tut}, einem Fortsetzungsmarker), von Adverbien (\N{le\ACC{ye'}krr} \E{früh, zeitig} von \N{\ACC{ye'}krr} \E{früh}) sowie von Zusammensetzungen oder Phrasen (\N{le\ACC{pxìm}run} \E{gewöhnlich, häufig anzutreffen} von \N{pxìm} \E{oft} und \N{run} \E{finden}).
...
\subsubsection{} Mit den genannten Präfixen können Stammsilben einen Vokal verlieren, wenn der anlautende Konsonant auch ein gültiger auslautender Konsonant ist, \N{nìm\ACC{wey}pey} \E{auf geduldige Weise} aus \N{ma\ACC{wey}pey} \E{sich gedulden, geduldig sein}.
...
\subsubsection{} Wenn \N{le-} vor \N{ke-} steht, wird das Negationspräfix auf \N{-k-} reduziert, wie in \N{lek\ACC{ye}'ung} \E{wahnsinnig, verrückt} aus \N{ke\ACC{ye}'ung} \E{Wahnsinn, Irrsinn}.
...
\subsection{Adverbiales a-} Zwei Zustandsverben, \N{lìm} \E{fern sein} und \N{sim} \E{nah sein, näher sein} haben die adverbialen Formen \N{a\ACC{lìm}} \E{weit entfernt} und \N{a\ACC{sim}} \E{nahe, aus nächster Nähe}. Diese werden als ,versteinerte‘ Abkürzungen von Formen wie \N{nìfya'o a lìm} (\horenref{syn:nifyao}) betrachtet. Sie sind lexikalisierte Elemente und haben keine alternativen Formen wie \N{*lìma} und \N{*sima}.
\index{-a-@\textbf{-a-}!mit Adverbien}\index{aliìm@\textbf{alìm}}\index{asim@\textbf{asim}}\LNWiki{17/5/2010}{https://wiki.learnnavi.org/index.php/Canon/2010/March-June\%23Near.2C_Distant_and_Irregular_Adverbs}
...
\subsubsection{} \N{Tì- ‹us›} bildet das Gerundium (substantiviertes Verb).\footnote{In der deutschen Grammatik wird die Bezeichnung ,Gerundium‘ nicht verwendet, weil es in der modernen deutschen Sprache kein Gerundium im eigentlichen Sinne mehr gibt (\href{https://de.wikipedia.org/wiki/Gerundium}{vgl. Wikipedia: Gerundium}, \href{https://de.wikipedia.org/wiki/Substantivierung}{Substantivierung}).} Es ist voll produktiv für Verb-stämme und Zusammensetzungen (\N{si}-Verben -- siehe \horenref{lingop:si-const} -- können nicht in ein Gerundium verwandelt werden). Dies ist vor allem dann sinnvoll, wenn eine einfache \N{tì}-Ableitung bereits eine feste Bedeutung hat, wie in \N{rey} \E{leben}, \N{tì\ACC{rey}} \E{Leben}, aber \N{tìru\ACC{sey}} \E{das Leben, i. S. v. ,zu leben‘}. Bei zusammengesetzten Verben steht \N{tì-} am Anfang des Wortes und \N{‹us›} wird in das verbale Element der Zusammensetzung eingefügt; \N{yomtìng} wird zu \N{tìyomtusìng}. Siehe auch
\horenref{syn:gerund}.
\index{Gerundium!Bildung}\label{lingop:gerund}\index{si-Konstruktion@\textbf{si}-Konstruktion!kein Gerundium}\LNForum{31/1/2013}{https://forum.learnnavi.org/index.php?msg=572997}
...
\label{lingop:dimin}\index{Diminutiv}\index{tsyiìp@\textbf{-tsyìp}}\NTeri{11/7/2010}{https://naviteri.org/2010/07/diminutives-conversational-expressions/}
...
\subsubsection{} Drittens kann der Diminutiv eine Herabsetzung oder Beleidigung ausdrücken: 
\begin{interlin}
	\glll \Npawl{}\uwave{Fìtaronyutsyìp} ke tsun ke'ut stivä'ni. \\
	fì-taronyu-tsyìp ke tsun ke'u-t st\INF{iv}ä'ni \\
	\I{dem.prox}-Jäger-\I{dim} \I{neg} können nichts-\I{pat} fangen\INF{\I{subj}} \\
	\trans{Dieser \uwave{wertlose Jäger} kann nichts fangen.}
\end{interlin}

Der abschätzige Ton kann auch auf sich selbst gerichtet sein: 

\begin{interlin}
	\glll \Npawl{}Nga nìawnomum to \uwave{oetsyìp} lu txur nìtxan. \\
	nga nìawnomum to oe-tsyìp lu txur nì-txan \\
	\I{2sg} bekanntlich \I{comp} \I{1sg-dim} sein stark \I{advz}-viel \\
	\trans{Du bist bekanntlich viel stärker als \uwave{meine Wenigkeit}.}
\end{interlin}

\noindent Nur über den Kontext kann die die abschätzige von der liebevollen Verwendung des Diminutivs unterschieden werden.

\subsection{-nay} Durch dieses Suffix wird ein neues Substantiv gebildet, das auf etwas Niedrigeres in einer Hierarchie (Größe, Rang, Leistung usw.) hinweist. Das Suffix erhält die Betonung, \N{karyu\ACC{nay}} \E{Lehrer in Ausbildung, Referendar} aus \N{karyu} \E{Lehrer}. Wenn das Substantiv auf \N{-n} endet, verliert das Suffix das \N{-n-}, \N{'eyla\ACC{nay}} \E{Bekannte/r} aus \N{'eylan} \E{Freund}, \N{ikra\ACC{nay}} \E{Wald-Banshee} aus \N{ikran} \E{Banshee}. Es ist nicht produktiv.
\index{-nay@\textbf{-nay}}
\NTeri{28/2/2013}{https://naviteri.org/2013/02/vospxi-ayol-posti-apup-short-post-for-a-short-month/}

\subsection{Geschlechtssuffixe} Die geschlechtsspezifischen Suffixe sind insofern ungewöhnlich, als sie nicht nur mit Substantiven, sondern auch mit den Pronomen der dritten Person verwendet werden (\horenref{morph:pron:gender}).\label{lingop:suffix:gender}
...
\noindent Die Reduplikation ist ein nicht-produktiver Ableitungsprozess. Es gibt einige gebräuchliche Wörter, die sie verwenden. \index{Reduplikation}

\subsection{Iteration} Bei Adverbien der Zeit zeigt die Reduplikation Wiederholung oder Gewohnheitsmäßigkeit an, \N{letrrtrr} \E{gewöhnlich, i. S. v. ,täglich vorkommend‘}, \N{krro krro} \E{gelegentlich}.

\subsection{Verschiebung des Grades} Mit den Verben \N{'ul} \E{zunehmen} und \N{nän} \E{abnehmen} markieren reduplizierte Adverbien Veränderungen über die Zeit, \N{nì'ul'ul} \E{zunehmend, mehr und mehr}, \N{nì-nänän}\footnote{Die Reduplikation ist hier partiell, da Konsonanten nicht verdoppelt werden können.} \E{weniger und weniger}.
\NTeri{29/2/2012}{https://naviteri.org/2012/02/trr-asawnung-lefpom-happy-leap-day/}

\section{Kompositionen}

\subsection{Kopf} Das dominante (d. h. die grammatischen Eigenschaften des Wortes bestimmende) Element eines Na'vi-Kompositums kann an erster (Kopf-links) oder letzter (Kopf-rechts) Stelle der Komposition stehen.\footnote{Viele menschliche Sprachen sind restriktiver. Bei englischen Komposita z. B. steht das dominante Element (der ,Kopf‘) generell zuletzt, wie in \textit{blueberry}, \textit{night-light}, \textit{blackboard}. Im Deutschen ist es ähnlich, wie in \textit{Krautsalat}, \textit{Tischplatte} oder \textit{weinrot}. Andererseits nutzt das Vietnamesische das Kopf-links-Prinzip für eigene Kompositionen und das Kopf-rechts-Prinzip für Kompositionen, die es aus dem chinesischen Vokabular entlehnt hat.} Es besteht jedoch eine starke Tendenz zum Kopf-rechts-Prinzip bei Komposita. Verbkompositionen folgen am ehesten dem Kopf-links-Prinzip.

\subsubsection{} Komposita gehören der Wortklasse ihres Kopfes an, z. B. ist \N{\ACC{txam}pay} \E{Meer} ein Substantiv, weil \N{pay} \E{Wasser} ein Substantiv ist.

\subsubsection{} Wie die Wortstämme können auch die Komposita ihre Wortklasse durch Hinzufügen der oben aufgeführten Derivationsaffixe ändern, \N{lefpom\ACC{tokx}} \E{gesund} aus \N{fpom\ACC{tokx}} \E{Gesundheit}.
...
\subsubsection{} Die normale Stamm $+$ \N{si}-Wortfolge wird bei der Negation im Aussage- und Befehlssatz aufgehoben (siehe jeweils \horenref{syn:neg:si-const} und \horenref{syntax:prohibitions}):

\begin{interlin}
	\glll Oe pamrel ke si. \\
	oe pamrel ke si \\
	\I{1sg} Schrift \I{neg} \I{aux} \\
	\trans{Ich schreibe nicht.}
\end{interlin}
...
\begin{interlin}
	...
	txopu rä'ä si \\
	Angst \I{proh} \I{aux} \\
	\trans{Habe keine Angst.}
\end{interlin}

\section{Häufige und bemerkenswerte Kompositionselemente}

\subsection{-fkeyk} Abgeleitet von dem Substantiv \N{tìfkeytok} \E{Zustand, Situation}, bildet dieses unbetonte Suffix einige Wörter mit speziellen, idiomatischen Bedeutungen, wie z. B. \N{\ACC{ya}fkeyk} \E{Wetter}. Dennoch ist es sehr produktiv: 

\begin{interlin}
	\glll \Npawl{}Kilvanfkeyk lu fyape fìtrr? \\
	kilvan-fkeyk lu fya'o-pe fì-trr \\
	Fluss-Zustand sein Art.und.Weise-\I{q} \I{dem.prox}-Tag \\
	\trans{Wie ist der Zustand des Flusses heute?}
\end{interlin}
...
\subsection{-ìva} Wenn das Substantiv \N{ìlva} \E{Flocke, Tropfen, Span, Splitter} in Kompositionen verwendet wird, fällt das \N{l} weg, \N{\ACC{txe}pìva} (bzw. kurz \N{\ACC{txe}va}) \E{Asche, Schlacke}, \N{\ACC{her}wìva} \E{Schneeflocke}.
\NTeri{1/4/2011}{https://naviteri.org/2011/04/yafkeykiri-plltxe-frapo-everyone-talks-about-the-weather/}
...
\subsection{Sna-} Dieses Präfix ist eine verkürzte Form des Substantivs \N{sna'o} \E{Gruppe, Menge, Klumpen} und kann frei mit Lebewesen (außer Personen) verwendet werden, um eine natürliche Gruppierung anzuzeigen, wie \N{snatalioang} \E{eine Herde von Sturmbestien}, \N{snautral} \E{ein Bestand an Bäumen}.
...
\index{tsuk-@\textbf{tsuk-}}\index{ketsuk-@\textbf{ketsuk-}}\NTeri{22/3/2011}{https://naviteri.org/2011/03/\%E2\%80\%9Creceptive-ability\%E2\%80\%9D-and-hesitation/}

\subsubsection{} Darüber hinaus können intransitive Verben mit \N{tsuk-} kombiniert werden, wobei die Beziehung zwischen dem Substantiv und dem resultierenden Adjektiv loser ist: 

\begin{interlin}
	\glll \Npawl{}Fìtseng lu tsuktsurokx. \\
	fì-tseng lu tsuk-tsurokx \\
	\I{dem.prox}-Ort sein fähig-ausruhen \\
	\trans{Man kann sich hier ausruhen.}
\end{interlin}

\begin{interlin}
	\glll \Npawl{}Lu na'rìng tsukhahaw. \\
	lu na'rìng tsuk-hahaw \\
	sein Wald fähig-schlafen \\
	\trans{Man kann im Wald schlafen.}
\end{interlin}

\subsection{-tswo} Dieses Suffix kann frei auf jedes Verb angewendet werden und bildet ein Substantiv, das die Fähigkeit bezeichnet, die Handlung des Verbs auszuführen, \N{wemtswo} \E{Fähigkeit zu kämpfen}, \N{roltswo} \E{Fähigkeit zu singen}. Dieses Suffix ist abgeleitet von \N{tsu'o} \E{Fähigkeit}.
\NTeri{31/3/2012}{https://naviteri.org/2012/03/spring-vocabulary-part-2/}\index{-tswo@\textbf{-tswo}}
...
\LNForum{18/6/2010}{https://forum.learnnavi.org/index.php?msg=240892}

\subsection{Die momentane Zeit} Das Demonstrativpräfix \N{fì-} (\horenref{morph:prenoun:fi}) bildet ein Adverb für die aktuelle Zeiteinheit, \N{fìtrr} \E{heute} (wörtl. \E{dieser Tag}), \N{fìrewon} \E{heute Morgen}. Diese Formen können auch als Substantive benutzt werden: \Npawl{fìtrrä ftxozäri} \E{Feier dieses Tages.}
\index{fiì-@\textbf{fì-}!in Zeitadverbien}
\LNWiki{22/4/2010}{https://wiki.learnnavi.org/index.php/Earth_Day_Message}

\subsection{Die vorherige Zeit} Das betonte Suffix \N{-am} bildet ein Adverb für die vorherige Zeiteinheit, \N{trr\ACC{am}} \E{gestern}, \N{pxiswaw\ACC{am}} \E{vor einem Moment}, \N{txo\ACC{nam}} \E{vergangene Nacht.} Diese Formen können ebenfalls als Substantive benutzt werden: 

\begin{interlin}
	\glll \Npawl{}Kintrramä sätsyìl lu lehrrap. \\
	kintrr-am-ä sä-tsyìl lu le-hrrap \\
	Woche-\I{pst-gen} \I{nmlz}-klettern sein \I{adjz}-Gefahr\\
	\trans{Der Aufstieg von letzter Woche war gefährlich.}
\end{interlin}
\index{-am@\textbf{-am}}

\subsection{Die nachherige Zeit} Das betonte Suffix \N{-ay} bildet ein Adverb für die nächste Zeiteinheit, \N{trr\ACC{ay}} \E{morgen}, \N{ha'ngir\ACC{ay}} \E{morgen Nachmittag}. Auch diese Formen können als Substantive benutzt werden: 

\begin{interlin}
	\glll \Npawl{}Zìsìtayri srefereiey nìprrte'! \\
	zìsìt-ay-ri sref\INF{er}\INF{ei}ey nì-prrte' \\
	Jahr-\I{fut}-\I{top} erwarten\I{\INF{ipfv}\INF{pos.aff}} \I{advz}-angenehm\\
	\trans{(Ich) freue mich schon auf das nächste Jahr!}
\end{interlin}
\index{-ay@\textbf{-ay}}
