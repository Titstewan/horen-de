...
\index{Glottaler Plosiv!Lenition}\label{lands:lenition:pseudovowel}\NTeri{3/28/2012}{https://naviteri.org/2012/03/spring-vocabulary-part-1/}
...
\subsection{Numeruspräfixe} Präfixe, die Lenition verursachen, werden mit einem Pluszeichen anstelle des üblichen Bindestrichs gekennzeichnet, wie z. B. \N{ay+}, das lenierende Präfix für den Plural.\index{Lenition!Numeruspräfixe}
...
\subsection{Zahlen}\index{Lenition!Zahlen}
...
\index{Lenition!Eigennamen}\NTeri{10/28/2010}{https://naviteri.org/2010/09/getting-to-know-you-part-2/}

\subsection{Riff-Na'vi} \index{Riff-Na'vi!Lenition}
...
\label{lands:phonotactics:precontract}\index{Präfix!Kontraktion}\LNWiki{18/5/2011}{https://wiki.learnnavi.org/index.php/Canon/2011/April-December\%23Kawtseng.2C_tsapo_and_prefixes}
...
\index{Riff-Na'vi!Vokalkontraktion inhibited}\label{rn:no-contract}\NTeri{13/1/2023}{http://naviteri.org/2023/01/2653/}

\subsection{Pseudovokalkontraktion} Aufgrund der Form der Aspektinfixe \N{\INF{er}} und \N{\INF{ol}} ist es möglich, dass die Pseudovokale unmittelbar nach ihrem konsonantischen Gegenstück auftreten, wie in \N{*p\INF{ol}ll\ACC{txe}}. Wenn dies in einer unbetonten Silbe geschieht, verschwindet der Pseudovokal, \N{pol\ACC{txe}}. In einer betonten Silbe verschwindet das Infix, \N{*\ACC{f}\INF{er}\ACC{rr}fen} $>$ \N{\ACC{frr}fen}. Pseudovokale in einsilbigen Wörtern verhalten sich wie unbetont, \N{vol} von \N{*v\INF{ol}ll}. \index{Pseudovokal!Kontraktion}
