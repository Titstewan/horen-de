...
\subsection{Detransitiv} Das Reflexivinfix macht transitive Verben intransitiv.\footnote{Lernern romanischer Sprachen wird dies bekannt vorkommen: \textit{je lave ma voiture} (transitiv) vs. \textit{je me lave} (intransitiv).} Es kann aber in einige wenige \N{si}-Verben gesetzt werden, um neue, lexikalisierte Verben zu bilden, z. B. \N{win säpi} \E{sich beeilen}.\footnote{Anm. d. Ü.: Im Gegensatz zum Englischen, wo die Reflexivität oft verloren geht (\E{(to) hurry}), bleibt sie im Deutschen in diesem Fall erhalten.}
