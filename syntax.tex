...
\indent Alternativ zum Genitiv kann die Adposition \N{ta} verwendet werden, \Npawl{Na'vita luyu hapxì}.\linebreak \QUAESTIO{Es ist nicht klar, ob die Verwendung von Genitiv und \N{ta} immer beliebig ist.} \NTeri{10/1/2024}{https://naviteri.org/2025/01/tsaliu-alu-pum-aysaomum-asawnung-additional-information-about-pum/}
...
\noindent Man beachte, dass sich dies auf eine vergangene Handlung bezieht, die tatsächlich stattgefunden hat und richtig war, und nicht auf einen unerfüllten Wunsch in der Vergangenheit. Hierfür wird \N{sweylu zun} verwendet, \Npawl{sweylu zun nga kilvä} \E{Er hätte (besser) gehen sollen} (wörtl. \E{Es wäre besser gewesen, wenn er gegangen wäre}). Soll deutlich gemacht werden, dass die negative Konsequenz nicht in der Vergangenheit, sondern in der Gegenwart relevant ist, wird \N{sweylivu zun} verwendet, \Npawl{sweylivu zun nga kilvä} \E{Er hätte (besser) gehen sollen} (≈ \E{Die Situation wäre jetzt besser, wenn er gegangen wäre}).
