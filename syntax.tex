...
\begin{itemize*}
	\item Ist der ursprüngliche Ausdruck intransitiv, dominiert \N{\INF{äp}} und das Subjekt steht im Absolutiv: \Npawl{Oe täpeykaron.} \E{Ich bringe mich selbst dazu, zu jagen.}
	\item Ist der ursprüngliche Ausdruck transitiv, dominiert \N{\INF{eyk}} und das Subjekt steht im Agens: \Npawl{Oel täpeykaron yerikit.} \E{Ich bringe mich selbst dazu, einen Yerik zu jagen.}
\end{itemize*} 
...
\LNForum{1/3/2010}{https://forum.learnnavi.org/index.php?msg=123484}
...
\subsubsection{} \N{Sleyku}, der Kausativ von \N{slu} \E{werden}, nimmt ebenfalls ein adjektivisches Prädikativum an, \Npawl{fula tsayun oeng pivängkxo ye'rìn ulte ngari oel mokrit stayawm, \uwave{oeti nitram sleyku} nìtxan} \E{\uwave{Es macht mich sehr glücklich}, dass wir beide bald plaudern können und dass ich deine Stimme hören werde}. In gleicher Weise nimmt \N{'eykefu}, der Kausativ von \N{'efu}, ein adjektivisches Prädikativum an, \Npawl{fula horen sì aylì'fyavi amip lesar sayi mengar \uwave{oeti nitram 'eykefu} nìtxan} \E{\uwave{Es macht mich sehr glücklich}, dass die neuen Regeln und Wörter für euch beide nützlich sein werden.}
...
\subsubsection{} \N{Fko} kann mit dem Passiv übersetzt werden, wenn der Handelnde\footnote{Der Handelnde bzw. das Agens eines Verbs im Passiv ist die Person oder Sache, die in deutschen Passivkonstruktionen meist nach der Präposition ,von‘ steht, wie in ,Ich wurde \uwave{vom Auto} angefahren‘.} belebt ist, wie in der Redewendung \N{oeru syaw fko Wìlyìm} \E{Mein Name ist William / ich werde William genannt}, \Npawl{tsalì'uri fko pamrel si fyape?} \E{Wie wird dieses Wort geschrieben / Wie schreibt man dieses Wort?}
\label{syn:prn:fko}
...
Man beachte, dass das Reflexivpronomen dem Substantiv, auf das es sich bezieht, zuvorkommen kann, wie in \Npawl{sìpawmìri \uwave{sneyä aynumeyuä} karyu 'eyng} \E{Der Lehrer antwortet auf die Fragen seiner Schüler}. Hier steht \N{sneyä} vor \N{aynumeyu}.
...
\noindent Zusätzlich wird der Kontrast in dieser Konstruktion durch eine Betonung der unabhängigen Formen \N{\underline{fì}'u} und \N{\underline{tsa}'u} ausgedrückt (im ersten Beispiel durch Großschreibung markiert).
...
\subsubsection{} Bei Verben des Sprechens, einschließlich eines Wortes wie \N{pawm} \E{fragen}, steht die angesprochene Person im Dativ, \N{oel poru poleng fì'ut} \E{Ich habe ihm dies erzählt} (idiomatischer ist bei \N{pawm} jedoch die Adposition \N{ta} vor der angesprochenen Person).
...
\indent Alternativ zum Genitiv kann die Adposition \N{ta} verwendet werden, \Npawl{Na'vita luyu hapxì}.\linebreak \QUAESTIO{Es ist nicht klar, ob die Verwendung von Genitiv und \N{ta} immer beliebig ist.} \NTeri{10/1/2025}{https://naviteri.org/2025/01/tsaliu-alu-pum-aysaomum-asawnung-additional-information-about-pum/}
...
\subsection{Position} Adpositionen können an zwei Stellen stehen: Entweder stehen sie vor der gesamten Nominalphrase, die sie modifizieren und werden dann als separate Wörter geschrieben, \Npawl{\uwave{ta} peyä fahew akewong} \E{\uwave{mit (von)} seinem Aliengestank}, \Nfilm{ngari \uwave{hu Eywa} salew tirea} \E{Dein Geist geht \uwave{mit Eywa}}. Oder sie stehen enklitisch, in diesem Fall werden sie immer an das Wort angehängt, \Npawl{fìtrr\uwave{mì} letsranten} \E{an diesem wichtigen Tag}, \Npawl{aylì'u\uwave{fa} awngeyä 'eylanä a'ewan} \E{in den Worten unseres jungen Freundes}, \Npawl{lala tsarel\uwave{mì} arusikx} \E{in diesem alten Film}.
\index{Adpositionen!Position}\label{syn:adp:position}

\subsection{Lenisierung}\index{Plural!Kurzform} Einige Adpositionen verursachen Lenisierung im folgenden Wort. In Wörterbüchern werden diese in der Regel als ,adp.+‘ angegeben, wobei das Pluszeichen wie üblich die Lenisierung anzeigt.
...
\subsection{Li} Die Hauptbedeutung von \N{li} ist \E{schon, bereits}, \Npawl{tìkangkem li hasey lu} \E{Die Arbeit ist bereits erledigt.}
\index{li@\textbf{li}} 
\NTeri{20/2/2011}{https://naviteri.org/2011/02/new-vocabulary-part-2/}

\subsubsection{„bisher nicht“} Die Negation, \N{ke li}, bedeutet \E{noch nicht, bisher nicht} und verwendet doppelte Verneinung (\horenref{syn:neg:pleon}), \N{fo ke li ke polähem} \E{Sie sind noch nicht angekommen}.
\index{bisher nicht}\index{ke@\textbf{ke}!\textbf{ke li}}\NTeri{4/9/2011}{https://naviteri.org/2011/09/\%e2\%80\%9cby-the-way-what-are-you-reading\%e2\%80\%9d/\#comment-1093}

\subsubsection{Befehle} Bei Imperativen zeigt \N{li} besondere Dringlichkeit an: \Npawl{Ngal mi fìtsengit terok srak? Li kä!} \E{Du bist noch hier? Geh schon!} Mit \N{ko} (\horenref{syn:particle:ko}), \N{li ko} (betont auf \N{li}), bedeutet es \E{nun, dann mal los}, oder \E{lasst uns loslegen}.
...
\subsubsection{} \N{Nìfya'o} kann auch einen Relativsatz annehmen, \Npawl{nìfya'o a hek} \E{auf seltsame Art und Weise}.
...
\subsection{Aspekt} Im Allgemeinen wird im Na'vi der Aspekt gegenüber der Zeitform bevorzugt markiert.\footnote{Die Verbkategorie ,Aspekt‘ kann für Sprecher des Deutschen und vieler anderer europäischer Sprachen ungewohnt sein, da diese in ihren Verbformen Tempus und Aspekt oft vermischen, was es schwierig macht, die beiden Begriffe zu unterscheiden. Während das Tempus den Zeitpunkt einer Handlung relativ zum Zeitpunkt der Aussage verortet (d. h. in der Vergangenheit, Gegenwart oder Zukunft), drückt der Aspekt aus, wie sich die Handlung relativ zum betrachteten Zeitraum erstreckt (ob dieser in der Vergangenheit, Gegenwart oder Zukunft liegt, ist dabei irrelevant), und gibt z. B. an, ob die Handlung im betrachteten Zeitraum abgeschlossen wird oder nicht, ob sie darin einmalig, wiederholt oder gewöhnlich stattfindet, etc. (\href{https://de.wikipedia.org/wiki/Aspekt_(Linguistik)}{vgl. Wikipedia: Aspekt}). Ein deutsches Beispiel zur Verdeutlichung:
	...
	\end{quotation}
	In beiden Sätzen liegt die Handlung des Einkaufens in der Vergangenheit (d. h. das Tempus ist dasselbe), aber im zweiten Satz wird sie im Verlauf, d. h. unabgeschlossen (imperfektiv) geschildert und bildet damit den Hintergrund für die folgende Aussage, die abgeschlossen (perfektiv) bzw. punktuell ist.} Es ist hilfreich, sich das Perfekt als eine Momentaufnahme eines Ereignisses vorzustellen, während das Imperfekt den Hintergrund etabliert, \Npawl{tengkrr palulukan moene kxll \uwave{sarmi}, \uwave{poltxe} Neytiril aylì'ut a frakrr 'ok seyä layu oer} \E{Als der Thanator auf uns beide \uwave{zustürmte}, \uwave{sagte} Neytiri etwas, an das ich mich immer erinnern werde.}
...
\begin{quotation}
	...
	\indent\E{Wenn ich eine Antwort \uwave{erhalten habe}, werde ich es euch wissen lassen}.\\
...
\subsection{Absicht} Die beiden Infixe, die eine auf die Zukunft ausgerichtete Absicht\footnote{\href{https://de.wikipedia.org/wiki/Energikus}{Vgl. Wikipedia: Energikus}} markieren -- \N{\INF{ìsy}} und \N{\INF{asy}} -- zeigen eher die Entschlossenheit des Sprechers an, einen Zustand herbeizuführen, als eine Vorhersage über die Zukunft, \Npawl{\uwave{pìsyeng} oe ngar} \E{Ich werde es dir erzählen}, \Npawl{tafral ke \uwave{lìsyek} oel ngeyä keye'ungit} \E{Daher werde ich deinem Irrsinn keine Beachtung schenken}.

Bei Negation drücken die beiden Infixe die Absicht aus, dass etwas nicht passiert (und nicht etwa, nicht die Absicht zu haben, dass etwas passiert):

\begin{interlin}
	\glll Ayoe ke wasyem. \\
	ay-oe ke w\INF{asy}em \\
	\I{pl}-\I{1} nicht kämpfen\INF{\I{int.fut}} \\
...
\begin{interlin}
	...
	nicht fallen\INF{\I{int.fut}} lì'Ona zu Feind \I{rel} innen oder \I{rel} außen\\
	\trans{Die lì'Ona werden weder am äußeren noch am inneren Feind zugrunde gehen.} \Ipawl{}
\end{interlin}
...
Wenn das Modalverb jedoch ein Objekt oder einen Objektsatz nehmen kann, verhält es sich transitiv, \Npawl{oel new futa nga srew} \E{Ich möchte, dass du tanzt} (\horenref{syn:modal:subclause}).
...
Einige Modalverben können Objektsätze annehmen, die mit \N{futa} oder \N{a fì'ut} (\horenref{morph:fwa-tsawa}) eingeleitet werden. Wenn das Subjekt des Modalverbs mit dem des kontrollierten Vollverbs identisch ist, ist es normalerweise nicht notwendig, aber möglich, eine der Konjunktionen zu verwenden:
...
\end{quotation}
\noindent \LNForum{29/11/2020}{https://forum.learnnavi.org/index.php?msg=673724}
