...
\begin{interlin}
	\glll Oel foru fìaylì'ut tolìng a krr, kxawm oe harmahängaw. \\
	Oe-l fo-ru fì-ay-lì'u-t t\INF{ol}ìng a krr kxawm oe h\INF{arm}ah\INF{äng}aw \\
	\I{1sg-agt} \I{3pl-dat} \I{dem-pl}-Wort-\I{pat} geben\INF{\I{pfv}} \I{rel} Zeit vielleicht \I{1sg} schlafen\INF{\I{ipfv-pst}}\INF{\I{neg.aff}} \\
	\trans{Als ich ihnen diese Worte gab, schlief ich vielleicht gerade.}
\end{interlin}
