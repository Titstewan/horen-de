...
\subsubsection{} Ein Substantiv, das auf einen glottalen Plosiv endet, kann auch die Dativ-Endung \N{-ru} und Topik \N{-ri} annehmen, wie \Npawl{lì'fyaolo\uwave{'ru}} und \N{lì'fyaolo\uwave{'ri}}. Ansonsten nehmen Substantive, die auf Konsonanten enden, \N{-ur} und \N{-ìri} an.
...
\subsection{-Pe+} \label{morph:pre:pe} Dieses Interrogativaffix bedeutet \E{was, welche/r/s} wie in \N{pelì'u} \E{welches Wort?}. Es ist insofern ungewöhnlich, als es entweder ein Präfix (\N{pelì'u}) oder ein Suffix (\N{lì'upe}) sein kann. Wenn es als Präfix vorangestellt ist, wird das folgende Wort lenisiert wie \N{pehem} von \N{kem}. Wenn auf das Präfix die Pluralsilbe \N{ay+} folgt, kontrahieren die beiden Morpheme zu \N{pay+}. Wird \N{-pe+} als Suffix verwendet, können daran Fallendungen gehängt werden (z. B. \N{tupel}, \N{tsengpeti}).
Wenn \N{-pe} an ein Substantiv angehängt wird, bewirkt dies weder beim Substantiv selbst noch beim nachfolgenden Wort eine Lenition. Das angehängte \N{-pe} steht vor allen Kasusendungen. Es wurde jedoch erwähnt, dass \N{-pe} nach einer Kasusendung in der Spontansprache als mögliches, nicht normgerechtes Ergebnis vorkommen kann.
