...
\paragraph{Riff-Na'vi} \label{morph:reef-navi:pat} \index{Reef Na'vi!patientive}
Der Riff-Na'vi-Dialekt bevorzugt die Patiens-Form \N{-ti} gegenüber \N{-it} und \N{-t}. \Omaticon

\subsection{Entlehnte Substantive}\index{noun!declension!foreign}
...
\subsubsection{} Im Riff-Na'vi wird \N{pxe-} als \N{be-} ausgesprochen. \index{Reef Na'vi!trial prefix}
...
\subsubsection{} Es gibt eigene Pronomen der dritten Person für belebte und unbelebte Objekte. Tiere können mit dem belebten Pronomen \N{po} bezeichnet werden, nicht aber Insekten. Je wichtiger die Beziehung des Sprechers zum Tier ist, desto eher wird eine Form von \N{po} verwendet.\index{animacy}
...
\subsubsection{} In der informellen sowie in knapper Militärsprache kann das abschließende \N{ä} der Genitivendung bei Pronomen entfallen, \N{ngey 'upxaret}.\label{morph:pron:gen-clipped} \index{genitive!shortened
...
\subsubsection{} Das Reflexivpronomen \N{sno} kann keine Numerusmarkierung erhalten. \index{sno@\textbf{sno}!not marked for number}
...
Wenn es als Pronomen verwendet wird, hat \N{lahe} \E{andere} Plural-Kurzformen: 
...
\subsection{Kombinationen} Die Vorsilben können zu einem einzigen Wort kombiniert werden, und zwar in dieser Reihenfolge: \index{prenoun!combinations}
...
\subsubsection{} Kurze Pluralformen (\horenref{morph:short-plural}) werden nicht mit den deiktischen Präfixen verwendet; \N{tsaytele} \E{diese Angelegenheiten}, niemals *\N{tsatele} (Singular \N{txele}). \index{plural!short!not used with prenouns}
...
\subsubsection{} Es gibt nur zwei Partizip-Infixe. Sie lassen sich nicht mit Zeit-, Aspekt- oder Modus-Infixen kombinieren. \index{participle!formation}
