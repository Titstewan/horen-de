...
\begin{center}
	\begin{tabular}{lccc}
		...
		Absolutiv & --- & --- & --- \\
		Agens & \N{-l} & \N{-ìl} & \N{-ìl} \\
		Patiens & \N{-t}, \N{-ti} & \N{-it}, \N{-ti} & \N{-ti}, \N{-it}, \N{-ay-t(i)}, \N{-ey-t(i)} \\
...
\subsection{-Pe+} \label{morph:pre:pe} Dieses Interrogativaffix bedeutet \E{was, welche/r/s} wie in \N{pelì'u} \E{welches Wort?}. Es ist insofern ungewöhnlich, als es entweder ein Präfix (\N{pelì'u}) oder ein Suffix (\N{lì'upe}) sein kann. Wenn es als Präfix vorangestellt ist, wird das folgende Wort lenisiert. Folgt auf das Präfix die Pluralsilbe \N{ay+}, kontrahieren die beiden Morpheme zu \N{pay+}. Wird \N{-pe+} als Suffix verwendet, können daran Fallendungen gehängt werden, \Npawl{nga new yivom \uwave{'upet} fìtxon?} \E{Was möchtest du heute Nacht essen?}
