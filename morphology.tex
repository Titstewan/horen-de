...
\subsection{Fragen} Wie bei den Substantiven kann das Interrogativaffix \N{-pe+} entweder ein lenisierendes Präfix oder ein Suffix sein.

\begin{center}
	\begin{tabular}{rl}
		wer? & \N{pe\ACC{su}}, \N{\ACC{tu}pe} \\
		was (Sache)? & \N{pe\ACC{u}}, \N{\ACC{'u}pe} \\
		was (Aktion)? & \N{pe\ACC{hem}}, \N{\ACC{kem}pe} \\
